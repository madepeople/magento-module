...
class SveaWebPay_Hosted_Model_Order_Invoice_Total_Handlingfee extends Mage_Sales_Model_Order_Invoice_Total_Abstract
{
    public function collect(Mage_Sales_Model_Order_Invoice $invoice)
    {
        ...
        // If we happens to already used handlingfee when creating invoice we must not do it once more.
        if($invoiceId != "")
            return $this;
