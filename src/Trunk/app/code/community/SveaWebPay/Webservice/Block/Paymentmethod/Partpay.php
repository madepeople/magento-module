 ...
 */
 ...
 class SveaWebPay_Webservice_Block_Paymentmethod_Partpay extends Mage_Payment_Block_Form
 {
    protected function _construct()
    {
        parent::_construct();
        $this->setTemplate('sveawebpay/webservice/paymentmethod/form/partpay.phtml'); 
    }
