...
$this->startSetup();
$this->run("
          CREATE TABLE IF NOT EXISTS {$this->getTable('sveawebpay')} (
          ...
          ALTER TABLE {$this->getTable('sveawebpay')} CHANGE `sveawebpay_id` `sveawebpay_id` VARCHAR( 64 ) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL;
          ");
$this->endSetup();