 ...
 */
class Svea_WebPay_Model_Sales_Quote_Total_Paymentfee
    extends Mage_Sales_Model_Quote_Address_Total_Abstract
{
    ...
    public function collect(Mage_Sales_Model_Quote_Address $address)
    {
        ...
        $basePaymentFee = (float)$methodInstance->getConfigData('payment_fee_amount');
        if (empty($basePaymentFee)) {
            return $this;
        }

        $paymentFee = (float)$address->getQuote()->getStore()->convertPrice($basePaymentFee, false);
