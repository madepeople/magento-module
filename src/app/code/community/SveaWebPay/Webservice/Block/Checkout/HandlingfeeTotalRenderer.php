...
class SveaWebPay_Webservice_Block_Checkout_HandlingfeeTotalRenderer extends Mage_Checkout_Block_Total_Default
{ 
    protected $_template = 'sveawebpay/webservice/checkout/handlingfeetotalrenderer.phtml';
