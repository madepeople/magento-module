...
class SveaWebPay_Webservice_Block_Frontend_Sales_Order_View extends Mage_Core_Block_Template
{ 
    public function initTotals()
    {
        ...
        $displayType      = $paymentMethod->getConfigData('frontend_handling_fee_display_order');
