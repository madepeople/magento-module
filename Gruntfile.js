            ...
            test: {
                options: {
                    vendor: [
                        ...
                        "tests/js/dependencies/skin/frontend/base/default/onestepcheckout/js/window.js",
                        "tests/js/dependencies/skin/frontend/base/default/onestepcheckout/js/onestepcheckout.js",

                        'src/js/svea.js', // svea library

                        'tests/js/inline.js' // inline js collected from a checkout page
                    ],
